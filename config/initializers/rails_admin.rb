# RailsAdmin config file. Generated on October 21, 2013 11:46
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Zhenwu', 'Admin']
  ...
  # config.excluded_models = ['Ckeditor::Asset', 'Ckeditor::AttachmentFile', 'Ckeditor::Picture', 'Page', 'Post', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Ckeditor::Asset', 'Ckeditor::AttachmentFile', 'Ckeditor::Picture', 'Page', 'Post', 'User']
  ...
  #     configure :published, :boolean 
  #     configure :published_datetime, :datetime 
  #     configure :sane_name, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
